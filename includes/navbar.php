					...
					<ul>
						<li class="item-menu">
							...
							<div id="itemMenu" class="itemMenu">
								<a href="<?php echo HOME_URI ?>/beneficiario/acompanhamento" class="subitem" title="Acompanhar Solicitação">
									Acompanhar Solicitação
									<span class="material-symbols-outlined ms-2 fw-bold">
                                        chevron_right
                                    </span>   
								</a>
								<div id="itemMenuSub" class="subnivelDropdown">
									<a class="d-flex align-items-center subitem subitem_nivel" href='<?php echo HOME_URI."/beneficiario/acompanhamento/protocoloautorizacao"; ?>'> Protocolo de Autorização </a>
									<a class="d-flex align-items-center subitem subitem_nivel" href='<?php echo HOME_URI."/beneficiario/acompanhamento/protocolobeneficiario";?>'> Protocolo do Beneficiário </a>
								</div>
							</div>
...
<div id="navLateral" class="sidebar">
	...
	<ul class="itens-menu navbar-nav nav-sidebar">
		...
		<li>
			...
			<div class="sub-menu">
				<a href="<?php echo bloqueioSolicitacao() ? HOME_URI."/beneficiario/a/sp9" : HOME_URI."/beneficiario/solicitacao" ;?>" title="Solicitar Autorização">Solicitar Autorização</a>
