...
<div class="container">
	...
	<input type="hidden" name="cartUnimed" id="cartUnimed" value="<?php echo $_SESSION["carteira"]?>">
		...
		<div class="row mb-2">
			<h3>Acompanhamento do Protocolo do Beneficiário</h3>
			<div class="col-md-12 bloco mt-4">
				<div class="row">
					<div class="col-10 col-md-6">
						<input type="text" class="mb-0" name="protocolo" id="protocolo" placeholder="Protocolo - 00000000000000000000" title="Protocolo do atendimento" onkeypress="return somenteNumeros(event)">
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">				
				<button type="button" class="btn btn-primary" onclick="BuscarProtocoloBeneficiario(document.formBuscProtocolo.protocolo.value);" title="Buscar este protocolo">Buscar</button>
				<button type="button" class="btn btn-secondary" onclick="MostrarListaTodosProtocolosBeneficiario();" title="Buscar todos os protocolos">Listar todos</button>
			</div>
		</div>
	</form>
	<div id="bscprotocolobeneficiario"></div>
